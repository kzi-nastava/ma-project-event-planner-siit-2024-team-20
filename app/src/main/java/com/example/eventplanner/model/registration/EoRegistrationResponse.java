...
public class EoRegistrationResponse {
    private Long id;
    ...
    public EoRegistrationResponse(Long id, String name, String lastName, String email, String city, String address, String addressNum, String phoneNumber, String profileImage, boolean isActive, Set<Event> acceptedEvents, Set<Event> favouriteEvents) {
        this.id = id;
        this.name = name;
